...
export const TrdMenu = () => {
  ...
  return (
    <>
      <div className='relative w-[1480px] h-full top-[100px] flex flex-col justify-center items-center gap-8 min-h-[500px] max-h-[90vh] overflow-y-auto p-6 bg-gray-900'>
