        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
          ...
          <Dialog open={showFullPage} onClose={handleClose} fullWidth maxWidth={false}>
            <div className='relative max-h-[90vh] overflow-y-auto p-6'>
              ...
              {pageType === 'zootopia_react' && <ZootopiaReact open={open} onClose={handleClose} project={selectedProject} />}
              {pageType === 'Zootopia' && <ZootopiaOrigin open={open} onClose={handleClose} project={selectedProject} />}
              {pageType === 'The_Joyful_Delivery' && <TheJoyfulDelivery open={open} onClose={handleClose} project={selectedProject} />}
            </div>
          </Dialog>
          <ZootopiaReact/>
