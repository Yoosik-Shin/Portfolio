...
export const FstMenu = () => {
  return(
    <div className='relative w-[1480px] h-full top-[100px] flex flex-col justify-center items-center gap-3'>
      ...
      />
      <div id='photo-container' className='bg-[#50505017] text-[#d4d4d479] w-lg-[700px] w-md-[500px] w-sm-[200px] h-[300px] rounded-4xl text-xl flex justify-center items-center gap-20 shadow-md'>
        <div>
