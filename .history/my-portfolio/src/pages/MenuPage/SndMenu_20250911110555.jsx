...
import { SiSpringboot, SiMysql, SiStyledcomponents, SiTailwindcss, SiBootstrap, SiCssmodules } from "react-icons/si";
...
export const SndMenu = () => {
  ...
  const skills = [
    ...
    { name: "Bootstrap", icon: <SiBootstrap size={50} className="text-green-500" /> },
