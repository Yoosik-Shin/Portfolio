...
export const FstMenu = () => {
  return(
    <div className='relative w-[1480px] h-full top-[100px] flex flex-col justify-center items-center gap-12'>
      ...
      <div>
        <Accordion title="자기소개">
          {/* <TypeIt ... /> 또는 원하는 내용 */}
          <h1>💡 저는 이런 사람입니다.</h1>
          <span>- 호기심이 강해 새로운 도전을 즐기며 성장하는 것을 좋아합니다.</span>
          <span>- 더 좋은 방법을 항상 고민하고, 적용하는 일을 좋아합니다.</span>
          <span>- 산업 시스템 공학과에서 IT 기초 지식을 습득했습니다.</span>
          <span>- 더조은 컴퓨터 아카데미에서 [AI활용 풀스택 (프론트엔드,백엔드) 부트캠프 (자바,파이썬,플러터)] 교육과정을 수료하였습니다.</span>
        </span>
---

- 호기심이 강해 새로운 도전을 즐기며 성장하는 것을 좋아합니다.
- 더 좋은 방법을 항상 고민하고, 적용하는 일을 좋아합니다.
- 산업 시스템 공학과에서 IT 기초 지식을 습득했습니다.
- 더조은 컴퓨터 아카데미에서 [AI활용 풀스택 (프론트엔드,백엔드) 부트캠프 (자바,파이썬,플러터)] 교육과정을 수료하였습니다.
        </Accordion>
      </div>
    </div>
  )
