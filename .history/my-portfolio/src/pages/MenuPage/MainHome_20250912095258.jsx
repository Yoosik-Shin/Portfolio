...
const onBtn = () => {
  ...
  return (
    <>
    <div className="relative w-[80%] h-[890px] flex flex-col justify-center items-center gap-3 box-border font-bold text-2xl bg-amber-50 rounded-2xl">
    {/* <div className="relative w-full h-screen overflow-hidden"> */}
      ...
      {/* 어두운 오버레이 */}
      <div className="absolute inset-0 bg-[#25252591] rounded-2xl"></div>
        <TypeIt
    ...
    <Dialog open={open} onClose={handleClose}>
        <DialogTitle className="mt-3 text-center select-none">Login</DialogTitle>
        <DialogContent className="w-xl h-[300px] flex flex-col justify-center items-center gap-5 m-10 select-none">
          <div className="flex relative justify-center items-center m-3 gap-5">
            ...
            <input ref={refID} defaultValue="user" placeholder="ID"
                    className="m-3 rounded-md border-b border-black px-2 py-1 
          ...
          <button className="absolute bottom-[90px] flex justify-center items-center bg-[#3f3f3fe8] text-white w-[50%] h-[40px] rounded-full hover:bg-[#a5a5a5e8]
        ...
        <DialogActions>
          ...
          <botton className="text-black cursor-pointer select-none" onClick={handleClose}>Cancel</botton>
        </DialogActions>
      </Dialog>
    </>
  );
