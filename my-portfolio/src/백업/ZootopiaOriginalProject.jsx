...
const ZootopiaOriginalProject = () => {
  ...
  const TechBadge = ({ tech }) => (
    <span className="inline-block bg-green-600 text-white px-3 py-1 rounded-full text-sm mr-2 mb-2">
      {tech}
    </span>
  );
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <CollapsibleSection title="프로젝트 목표 및 담당 역할" id="goals" icon={Award}>
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-green-400 mb-3">👨‍💻 담당 역할</h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-300">
                  소셜 로그인이 있으면 사용자의 입장에서 편할 것 같았고 개인적으로도 꼭 해보고 싶어서 시도하였고 네이버 로그인을 우선적으로 시도
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-300">
                  소셜 로그인을 처음 적용하다보니 필터나 Spring Security 설정, user 테이블 수정 등 복잡한 것이 많았음
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-300">
                  AI를 최대한 활용하고 DB, 그리고 공통으로 사용하는 코드가 바뀌는 부분에 대해 팀원들과 공유하며 네이버 로그인을 성공적으로 구현
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-800 p-4 rounded-lg">
              ...
              <div className="space-y-1 text-sm">
                <p>• 추천 병원 및 반려동물 장례 페이지</p>
                <p>• 헤더 메뉴 및 서브메뉴 수정 및 기능추가</p>
                <p>• 소셜로그인 (네이버)</p>
              </div>
            </div>
...
export default ZootopiaOriginalProject;