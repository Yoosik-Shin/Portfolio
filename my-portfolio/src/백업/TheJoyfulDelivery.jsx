...
import { Github, ExternalLink, Code, Users, Calendar, MapPin, MessageCircle, Shield, Award, ChevronRight, ChevronDown, Monitor, Smartphone, Truck } from 'lucide-react';

const JoyfulDeliveryProject = () => {
    ...
    <div className="mb-6 bg-gray-800 rounded-lg overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          {Icon && <Icon size={20} className="text-orange-400" />}
  ...
  const TechBadge = ({ tech }) => (
    <span className="inline-block bg-orange-600 text-white px-3 py-1 rounded-full text-sm mr-2 mb-2">
      {tech}
    </span>
  );
...
export default JoyfulDeliveryProject;